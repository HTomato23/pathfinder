            ...
            <div class="flex flex-col gap-4">
                ...
                <div class="flex flex-col sm:flex-row justify-between items-start lg:items-center gap-2">
                    <div class="flex flex-col font-outfit">
                        <p class="text-sm">{{ $client->password_changed_at ? $client->password_changed_at->diffForHumans() : 'Never changed' }}</p>
                    </div>
                       ...
                       <!-- Current Password -->
                        ...
                        <div class="mt-4 flex justify-end">
                            <span class="flex items-center gap-2">
                               Show Password <input x-model="show" type="checkbox" class="checkbox checkbox-sm""> 
                            </span>
                        </div>
